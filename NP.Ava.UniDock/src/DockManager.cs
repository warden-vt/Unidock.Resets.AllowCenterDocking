            ...
            try
            {
                ...
                if (draggedGroup != null)
                {
                    switch (currentDock)
                    {
                        ...
                        {
                            //warden-vt: This prevents center docking
                            if (!DockAttachedProperties.GetAllowCenterDocking(DraggedWindow) || !DockAttachedProperties.GetAllowCenterDocking(currentWindowToDropInto))
                                return;
